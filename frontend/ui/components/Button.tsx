...
/*
 * Documentation:
 * Button — https://app.subframe.com/3122e3d36a51/library?component=Button_3b777358-b86b-40af-9327-891efc6826fe
 */
    ...
    return (
      <button
        className={SubframeUtils.twClassNames(
          "group/3b777358 flex h-8 cursor-pointer items-center justify-center gap-2 rounded-md border-none bg-beta-navy px-3 hover:bg-beta-navy/90 active:bg-beta-navy disabled:cursor-default disabled:bg-neutral-200 hover:disabled:cursor-default hover:disabled:bg-neutral-200 active:disabled:cursor-default active:disabled:bg-neutral-200",
          {
            ...
            "bg-transparent hover:bg-beta-navy/10 active:bg-beta-navy/20":
              variant === "brand-tertiary",
            "bg-beta-navy/10 hover:bg-beta-navy/20 active:bg-beta-navy/10":
