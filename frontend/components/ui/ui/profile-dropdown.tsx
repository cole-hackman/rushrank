              ...
              <div className="p-6 border-b border-neutral-200 dark:border-neutral-700">
                ...
                >
                  <div className="flex justify-between mb-16">
                    <div className={effectiveTheme === "light" ? "text-neutral-800" : "text-white"}>
                      <svg
                        fill="currentColor"
                        width="30px"
                        height="30px"
                  ...
                  <div className="flex items-center mb-4">
                    <div className={`font-mono ${effectiveTheme === "light" ? "text-neutral-800" : "text-white"}`}>
                      Arihant Jain
                    </div>
                    <div className={`ml-auto font-mono ${effectiveTheme === "light" ? "text-neutral-800" : "text-white"}`}>
                      10/28
                    </div>
                  </div>

                  <div className={`font-mono text-xl tracking-widest ${effectiveTheme === "light" ? "text-neutral-800" : "text-white"}`}>
                    4242 4242 4242 4242
                  </div>
                </motion.div>
              </div>
                ...
                <div className="flex bg-neutral-100 dark:bg-neutral-700 rounded-lg p-1">
                  <motion.button
                    className={`flex-1 flex items-center justify-center py-2 px-4 rounded-md ${
                      effectiveTheme === "light" ? "bg-white dark:bg-neutral-600 shadow-sm" : ""
                    }`}
                    onClick={() => setTheme("light")}
                    whileHover={{ scale: effectiveTheme !== "light" ? 1.03 : 1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ type: "spring", stiffness: 400, damping: 17 }}
                  >
                    <Sun
                      className={`w-4 h-4 mr-2 ${
                        effectiveTheme === "light" ? "text-amber-500" : "text-neutral-500 dark:text-neutral-400"
                      }`}
                    />
                    <span
                      className={
                  ...
                  <motion.button
                    className={`flex-1 flex items-center justify-center py-2 px-4 rounded-md ${
                      effectiveTheme === "dark" ? "bg-neutral-600 shadow-sm" : ""
                    }`}
                    onClick={() => setTheme("dark")}
                    whileHover={{ scale: effectiveTheme !== "dark" ? 1.03 : 1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ type: "spring", stiffness: 400, damping: 17 }}
                  >
                    <Moon
                      className={`w-4 h-4 mr-2 ${
                        effectiveTheme === "dark" ? "text-indigo-300" : "text-neutral-500 dark:text-neutral-400"
                      }`}
                    />
                    <span className={effectiveTheme === "dark" ? "text-white font-medium" : "text-neutral-500 dark:text-neutral-400"}>
                      Dark mode
                    </span>
                  </motion.button>
                </div>
                  ...
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        ...
                        fill={effectiveTheme === "light" ? "black" : "white"}
                      />
                      <path
