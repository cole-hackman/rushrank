        ...
        <Table className="border-separate">
          <TableHeader className="sticky top-0 z-10 bg-gray-50/50 dark:bg-black backdrop-blur-xl">
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead className="text-left font-normal">Notes</TableHead>
              <TableHead className="text-left font-normal">Category</TableHead>
              <TableHead className="text-left font-normal">Selected</TableHead>
              <TableHead className="text-left font-normal">Actions</TableHead>
            </TableRow>
          </TableHeader>
          ...
          <TableFooter className="bg-transparent">
            <TableRow>
              <TableCell colSpan={9} className="text-center">
                <a
                  href="https://ruixen.com?utm_source=21st.dev&utm_medium=components&utm_campaign=ruixen"
                  target="_blank"
                  rel="noreferrer"
                >
