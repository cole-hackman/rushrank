...
export type SwipeableCardStackProps = {
	images?: string[];
	borderRadius?: number;
...
export function SwipeableCardStack({
	...
	const [dragDirections, setDragDirections] = React.useState<Record<number, SwipeDirection>>({});
				...
				{cards.map((image, index) => {
					...
					return (
						<motion.div
							...
							dragElastic={0.5}
							onDrag={(e, i) => handleDrag(e as any, i, index)}
							onDragEnd={(e, i) => handleDragEnd(e as any, i, index)}
							custom={{ direction }}
							...
							exit="exit"
							variants={{
								exit: (custom: { direction?: SwipeDirection }) => ({
